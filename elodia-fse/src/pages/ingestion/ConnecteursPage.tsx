...
const CONNECTEURS = [
  ...
  },
  {
    ...
    nom: 'Maiia',
    type: 'Cloud — Playwright',
    description: 'Extraction des rejets depuis le portail Cegedim Maiia',
    statut: 'bientot',
    priorite: 3,
  ...
  },
  {
    ...
    description: 'Acces distant via AnyDesk au poste cabinet puis scraping de l interface locale',
    statut: 'bientot',
    priorite: 4,
  ...
  },
  {
    ...
    description: 'Lecture directe des fichiers .rsp sur le poste local via AnyDesk',
    statut: 'bientot',
    priorite: 5,
  ...
  },
  {
    ...
    nom: 'Docteur Sante',
    type: 'Cloud — Playwright',
    description: 'Extraction depuis le portail Docteur Sante',
    statut: 'bientot',
    priorite: 6,
